...
export default function AboutUs(){
    ...
    return (
        ...
        <AboutUsComponant imgUrl={"/img/gonzo.jpg"} name={'Goncalo Rodrigues'} linkedin={"https://www.linkedin.com/in/goncalo-rodrigues07062000"} linkgithub={"https://github.com/GoncaloRod2000"}/>
